...
static const struct ieee80211_regdomain regdom_IL = {
	...
	.reg_rules = {
		REG_RULE(2402, 2482, 40, 0, 20, 0),
		REG_RULE(5150, 5250, 20, 0, 20, 
			NL80211_RRF_DFS | 
			NL80211_RRF_NO_IBSS | 0),
		REG_RULE(5250, 5350, 20, 0, 20, 
			NL80211_RRF_DFS | 
			NL80211_RRF_NO_IBSS | 0),
	},
	.n_reg_rules = 3
...
static const struct ieee80211_regdomain regdom_DB = {
	.alpha2 = "DB",
	.reg_rules = {
		REG_RULE(2302, 2382, 20, 0, 5, 0),
		REG_RULE(2402, 2482, 20, 0, 5, 0),
		REG_RULE(5110, 5250, 20, 0, 5, 0),
		REG_RULE(5250, 5710, 20, 0, 5, 
			NL80211_RRF_DFS | 0),
		REG_RULE(5735, 5835, 20, 0, 5, 0),
	},
	.n_reg_rules = 5
};
...
static const struct ieee80211_regdomain regdom_K2 = {
	.alpha2 = "K2",
	.reg_rules = {
		REG_RULE(2302, 2382, 20, 0, 20, 0),
		REG_RULE(2402, 2482, 20, 0, 20, 0),
...
static const struct ieee80211_regdomain regdom_K3 = {
	.alpha2 = "K3",
	.reg_rules = {
		REG_RULE(2402, 2482, 20, 0, 20, 0),
		REG_RULE(5170, 5250, 20, 0, 20, 
